...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nNumberList =(RecyclerView) findViewById(R.id.rv_numbers);
        ...
        nNumberList.setAdapter(mAdapter);
    }
}
