...
public class MainActivity extends AppCompatActivity {
    ...
    static final String RAW_JSON = "json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(RAW_JSON)){
                mSearchResultsTextView.setText((String) savedInstanceState.get(RAW_JSON));
            }
            if (savedInstanceState.containsKey(QUERY_URL)){
                mUrlDisplayTextView.setText((String) savedInstanceState.get(QUERY_URL));
            }
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String urlToBeSaved = mUrlDisplayTextView.getText().toString();
        String jsonToBeSaved = mSearchResultsTextView.getText().toString();

        outState.putString(QUERY_URL, urlToBeSaved);
        outState.putString(RAW_JSON, jsonToBeSaved);
