...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        new GithubQueryTak().execute(githubSearchUrl);
    ...
    public class GithubQueryTak extends AsyncTask<URL, Void, String>{
        @Override
        protected String doInBackground(URL... urls) {
            ...
            try {
                urlSearchResults = NetworkUtils.getResponseFromHttpUrl(searchUrl);
            } catch (IOException e){
              e.printStackTrace();
            }
